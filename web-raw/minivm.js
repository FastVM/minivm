...
function findWasmBinary() {
  ...
  return new URL('minivm.wasm', import.meta.url).href;
}
...
var ASM_CONSTS = {
  148496: () => { return Module._vm_canvas_mouse_x() },  
 148531: () => { return Module._vm_canvas_mouse_y() }
};
function vm_canvas_frame() { Module._vm_canvas_frame(); }
function vm_canvas_rect(x,y,w,h,r,g,b,a) { Module._vm_canvas_draw_rect(x, y, w, h, r, g, b, a); }
function vm_canvas_mouse_down(button) { return Module._vm_canvas_mouse_pressed(button); }
function vm_canvas_mouse_pressed(button) { return !Module._vm_canvas_mouse_pressed_last(button) && Module._vm_canvas_mouse_pressed(button); }
function vm_canvas_key_down(key) { return Module._vm_canvas_key_pressed(key); }
function vm_canvas_key_up(key) { return !Module._vm_canvas_key_pressed(key); }
function vm_canvas_key_pressed(key) { return !Module._vm_canvas_key_pressed_last(key) && Module._vm_canvas_key_pressed(key); }
function vm_canvas_key_released(key) { return Module._vm_canvas_key_pressed_last(key) && !Module._vm_canvas_key_pressed(key); }
function vm_canvas_set_size(w,h) { return Module._vm_canvas_set_size(w, h); }
function vm_std_app_frame_loop(vm) { Module._vm_std_app_frame_loop(vm); }
...
var wasmImports = {
  ...
  vm_canvas_key_down,
  /** @export */
  vm_canvas_key_pressed,
  /** @export */
  vm_canvas_key_released,
  /** @export */
  vm_canvas_key_up,
  /** @export */
  vm_canvas_mouse_down,
  /** @export */
  vm_canvas_mouse_pressed,
  /** @export */
  vm_canvas_rect,
  /** @export */
  vm_canvas_set_size,
  /** @export */
  vm_std_app_frame_loop
};
var wasmExports = createWasm();
var ___wasm_call_ctors = wasmExports['__wasm_call_ctors']
var _main = Module['_main'] = wasmExports['__main_argc_argv']
var _vm_std_app_frame = Module['_vm_std_app_frame'] = wasmExports['vm_std_app_frame']
var _vm_std_app_sync = Module['_vm_std_app_sync'] = wasmExports['vm_std_app_sync']
var __emscripten_stack_restore = wasmExports['_emscripten_stack_restore']
var __emscripten_stack_alloc = wasmExports['_emscripten_stack_alloc']
var _emscripten_stack_get_current = wasmExports['emscripten_stack_get_current']
var dynCall_jiji = Module['dynCall_jiji'] = wasmExports['dynCall_jiji']
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 129536;
