...
#define GC_CLANG_PREREQ_FULL(major, minor, patchlevel) \
    (GC_CLANG_PREREQ(major, (minor) + 1) || (__clang_major__ == (major) && __clang_minor__ == (minor) && __clang_patchlevel__ >= (patchlevel)))
#else
...
/* And one for FreeBSD: */
#if (defined(__FreeBSD__) || defined(__DragonFly__) || defined(__FreeBSD_kernel__)) && !defined(FREEBSD) && !defined(GC_NO_FREEBSD) /* Orbis compiler defines __FreeBSD__ */
#define FREEBSD
#endif
...
#endif
#endif
#if defined(__aarch64__) && !defined(DARWIN) && !defined(LINUX) && !defined(FREEBSD) && !defined(NETBSD) && !defined(OPENBSD) && !defined(QNX) && !defined(NN_BUILD_TARGET_PLATFORM_NX) && !defined(_WIN32)
#define AARCH64
#define NOSYS
#define mach_type_known
#endif
...
#if defined(NACL)
#define mach_type_known
#elif !defined(DARWIN) && !defined(LINUX) && !defined(FREEBSD) && !defined(NETBSD) && !defined(OPENBSD) && !defined(QNX) && !defined(NN_PLATFORM_CTR) && !defined(SN_TARGET_PSP2) && !defined(SYMBIAN) && !defined(_WIN32) && !defined(__CEGCC__) && !defined(GC_NO_NOSYS)
#define NOSYS
#define mach_type_known
#endif
#endif
...
#define mach_type_known
#endif
#if (defined(mips) || defined(__mips) || defined(_mips)) && !defined(__TANDEM) && !defined(LINUX) && !defined(FREEBSD) && !defined(NETBSD) && !defined(OPENBSD)
#define MIPS
...
#define mach_type_known
#endif
#if (defined(__BORLANDC__) || defined(__MINGW32__)) && !defined(mach_type_known)
#define I386
#define MSWIN32
#define mach_type_known
#endif
...
#if defined(__aarch64__) && (defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(QNX))
#define AARCH64
#define mach_type_known
#elif defined(__arc__) && defined(LINUX)
#define ARC
#define mach_type_known
#elif (defined(__arm) || defined(__arm__) || defined(__arm32__) || defined(__ARM__)) && (defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(QNX) || defined(NN_PLATFORM_CTR) || defined(SN_TARGET_PSP2))
#define ARM32
#define mach_type_known
...
#define HEXAGON
#define mach_type_known
#elif (defined(__i386__) || defined(i386) || defined(__X86__)) && (defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(QNX))
#define I386
#define mach_type_known
...
#define M32R
#define mach_type_known
#elif ((defined(__m68k__) || defined(m68k)) && (defined(NETBSD) || defined(OPENBSD))) || (defined(__mc68000__) && defined(LINUX))
#define M68K
#define mach_type_known
#elif (defined(__mips) || defined(_mips) || defined(mips)) && (defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD))
#define MIPS
#define mach_type_known
#elif (defined(__NIOS2__) || defined(__NIOS2) || defined(__nios2__)) && defined(LINUX)
#define NIOS2 /* Altera NIOS2 */
#define mach_type_known
#elif defined(__or1k__) && defined(LINUX)
#define OR1K /* OpenRISC (or1k) */
#define mach_type_known
#elif (defined(__powerpc__) || defined(__powerpc64__) || defined(__ppc__) || defined(__ppc64__) || defined(powerpc) || defined(powerpc64)) && (defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD))
#define POWERPC
#define mach_type_known
#elif defined(__riscv) && (defined(LINUX) || defined(FREEBSD) || defined(OPENBSD))
#define RISCV
#define mach_type_known
#elif defined(__s390__) && defined(LINUX)
#define S390
#define mach_type_known
#elif defined(__sh__) && (defined(LINUX) || defined(NETBSD) || defined(OPENBSD))
#define SH
#define mach_type_known
#elif (defined(__sparc__) || defined(sparc)) && (defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD))
#define SPARC
#define mach_type_known
#elif defined(__sw_64__) && defined(LINUX)
#define SW_64
#define mach_type_known
#elif (defined(__x86_64) || defined(__x86_64__) || defined(__amd64__) || defined(__X86_64__)) && (defined(DARWIN) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(OPENBSD) || defined(QNX))
#define X86_64
#define mach_type_known
#endif
...
#if GC_GNUC_PREREQ(2, 8) && !GC_GNUC_PREREQ(11, 0)                               /* broken at least in 11.2.0 on cygwin64 */ \
    && !defined(__INTEL_COMPILER) && !defined(__PATHCC__) && !defined(__FUJITSU) /* for FX10 system */                       \
    && !(defined(POWERPC) && defined(DARWIN))                                    /* for MacOS X 10.3.9 */                    \
    && !defined(E2K) && !defined(RTEMS) && !defined(__ARMCC_VERSION)             /* does not exist in armcc gnu emu */       \
    && (!defined(__clang__) || GC_CLANG_PREREQ(8, 0) /* was no-op in clang-3 at least */)
...
#define DYNAMIC_LOADING
#endif
#if defined(__ELF__) && !defined(ARC) && !defined(RISCV) && !defined(S390) && !defined(TILEGX) && !defined(TILEPRO)
extern int _end[];
...
#define GC_PREFETCH_FOR_WRITE(x)       \
    __asm__ __volatile__("dcbtst 0,%0" \
                         :             \
                         : "r"((const void *)(x)))
#endif
#endif
...
#define GC_PREFETCH_FOR_WRITE(x)        \
    __asm__ __volatile__("prefetchw %0" \
                         ...
                         : "m"(*(char *)(x)))
#endif
#if defined(__GLIBC__) && !defined(__UCLIBC__) && !defined(GLIBC_TSX_BUG_FIXED)
...
#define PREFETCH(x)                \
    __asm__("        lfetch  [%0]" \
            ...
            : "r"(x))
#define GC_PREFETCH_FOR_WRITE(x)           \
    __asm__("        lfetch.excl     [%0]" \
            :                              \
            : "r"(x))
#define CLEAR_DOUBLE(x)                       \
    __asm__("        stf.spill       [%0]=f0" \
            :                                 \
            : "r"((void *)(x)))
#else
EXTERN_C_END
...
#define USE_MMAP_ANON
#endif
#if defined(__GLIBC__) && !defined(__UCLIBC__) && !defined(GETCONTEXT_FPU_BUG_FIXED)
...
#ifdef MSWIN32
#define RETRY_GET_THREAD_CONTEXT
#if !defined(__GNUC__) || defined(__INTEL_COMPILER) || (GC_GNUC_PREREQ(4, 7) && !defined(__MINGW64__))
...
#if defined(GC_LINUX_THREADS) && defined(REDIRECT_MALLOC) && !defined(USE_PROC_FOR_LIBRARIES) && !defined(NO_PROC_FOR_LIBRARIES)
...
#if !defined(MSWIN32) && !defined(MSWINCE) && !defined(CYGWIN32) && !defined(GETPAGESIZE)
#if defined(AIX) || defined(DARWIN) || defined(IRIX5) || defined(LINUX) || defined(FREEBSD) || defined(NETBSD) || defined(SOLARIS)
EXTERN_C_END
#include <unistd.h>
EXTERN_C_BEGIN
#endif
...
#if defined(HOST_ANDROID) && !(__ANDROID_API__ >= 23) && ((defined(MIPS) && (CPP_WORDSZ == 32)) || defined(ARM32) || defined(I386) /* but not x32 */)
...
#if defined(FREEBSD) && (defined(__DragonFly__) || __FreeBSD__ >= 4 || __FreeBSD_kernel__ >= 4 || defined(__GLIBC__))
#define SUNOS5SIGS
#endif

#if defined(FREEBSD) || defined(HAIKU) || defined(HURD) || defined(IRIX5) || defined(NETBSD) || defined(OPENBSD) || defined(OSF1) || defined(SUNOS5SIGS)
#define USE_SEGV_SIGACT
#if defined(IRIX5) && defined(_sigargs) /* Irix 5.x, not 6.x */ \
    || (defined(FREEBSD) && defined(SUNOS5SIGS)) || defined(HPUX) || defined(HURD) || defined(NETBSD)
/* We may get SIGBUS.       */
...
#if defined(SVR4) || defined(LINUX) || defined(IRIX5) || defined(HPUX) || defined(OPENBSD) || defined(NETBSD) || defined(FREEBSD) || defined(DGUX) || defined(BSD) || defined(HAIKU) || defined(HURD) || defined(AIX) || defined(DARWIN) || defined(OSF1) || defined(QNX)
...
#if defined(USE_MUNMAP) && !defined(MUNMAP_THRESHOLD) && (defined(SN_TARGET_PS3) || defined(SN_TARGET_PSP2) || defined(MSWIN_XBOX1))
...
#if !defined(PCR_VDB) && !defined(PROC_VDB) && !defined(MPROTECT_VDB) && !defined(GWW_VDB) && !defined(SOFT_VDB) && !defined(DEFAULT_VDB) && !defined(GC_DISABLE_INCREMENTAL)
#define DEFAULT_VDB
#endif

#if !defined(PROC_VDB) && !defined(SOFT_VDB) && !defined(NO_VDB_FOR_STATIC_ROOTS)
/* Cannot determine whether a static root page is dirty?      */
#define NO_VDB_FOR_STATIC_ROOTS
#endif

#if ((defined(UNIX_LIKE) && (defined(DARWIN) || defined(HAIKU) || defined(HURD) || defined(OPENBSD) || defined(QNX) || defined(ARM32) || defined(AVR32) || defined(MIPS) || defined(NIOS2) || defined(OR1K))) || (defined(LINUX) && !defined(__gnu_linux__)) || (defined(RTEMS) && defined(I386)) || defined(HOST_ANDROID)) && !defined(NO_GETCONTEXT)
...
#if defined(GC_LINUX_THREADS) && defined(REDIRECT_MALLOC) && defined(__GLIBC__) && !GC_GLIBC_PREREQ(2, 34) && !defined(HAVE_LIBPTHREAD_SO)
...
#if defined(PCR) || defined(GC_WIN32_THREADS) || defined(GC_PTHREADS) || ((defined(NN_PLATFORM_CTR) || defined(NINTENDO_SWITCH) || defined(SN_TARGET_PS3) || defined(SN_TARGET_PSP2)) && defined(GC_THREADS))
#define THREADS
#endif
...
#if defined(CYGWIN32) && (defined(MPROTECT_VDB) || defined(USE_MUNMAP)) || (!defined(MSWIN32) && !defined(MSWINCE) && !defined(CYGWIN32) && (defined(GC_DISABLE_INCREMENTAL) || defined(DEFAULT_VDB)) && !defined(USE_MMAP))
...
#if defined(GC_PTHREADS) && !defined(GC_DARWIN_THREADS) && !defined(GC_WIN32_THREADS) && !defined(PLATFORM_STOP_WORLD) && !defined(SN_TARGET_PSP2)
...
#if (defined(E2K) || defined(HP_PA) || defined(IA64) || defined(M68K) || defined(NO_SA_SIGACTION)) && defined(SIGNAL_BASED_STOP_WORLD)
#define SUSPEND_HANDLER_NO_CONTEXT
#endif

#if (defined(MSWIN32) || defined(MSWINCE) || (defined(USE_PROC_FOR_LIBRARIES) && defined(THREADS))) && !defined(NO_CRT) && !defined(NO_WRAP_MARK_SOME)
...
#if !defined(MSWIN32) && !defined(MSWINCE) || defined(__GNUC__) || defined(NO_CRT)
...
#if defined(PARALLEL_MARK) && defined(GC_PTHREADS) && !defined(GC_PTHREADS_PARAMARK) && !defined(__MINGW32__)
...
#if (!defined(GC_DLL) && !defined(GC_INSIDE_DLL)) || defined(GC_PTHREADS) || defined(MSWINCE) || defined(NO_CRT) || defined(THREAD_LOCAL_ALLOC)
#define GC_NO_THREADS_DISCOVERY
#endif
#else
#define GC_NO_THREADS_DISCOVERY
...
#if defined(GC_DISCOVER_TASK_THREADS) && defined(GC_NO_THREADS_DISCOVERY) && !defined(CPPCHECK)
#error Defined both GC_DISCOVER_TASK_THREADS and GC_NO_THREADS_DISCOVERY
#endif

#if defined(PARALLEL_MARK) && !defined(DEFAULT_STACK_MAYBE_SMALL) && (defined(HPUX) || defined(GC_DGUX386_THREADS) || defined(NO_GETCONTEXT) /* e.g. musl */)
...
#if !defined(HAVE_CLOCK_GETTIME) && defined(_POSIX_TIMERS) && (defined(CYGWIN32) || (defined(LINUX) && defined(__USE_POSIX199309)))
#define HAVE_CLOCK_GETTIME 1
#endif
...
#if defined(CYGWIN32) && defined(GC_WIN32_THREADS) && defined(CAN_HANDLE_FORK) && !defined(EMULATE_PTHREAD_SEMAPHORE) && !defined(CYGWIN_SEM_FIXUP_AFTER_FORK_BUG_FIXED)
#define EMULATE_PTHREAD_SEMAPHORE
#endif

#if defined(CAN_HANDLE_FORK) && !defined(CAN_CALL_ATFORK) && !defined(GC_NO_CAN_CALL_ATFORK) && !defined(HOST_TIZEN) && !defined(HURD) && (!defined(HOST_ANDROID) || __ANDROID_API__ >= 21)
/* Have working pthread_atfork().     */
#define CAN_CALL_ATFORK
#endif

#if !defined(CAN_HANDLE_FORK) && !defined(HAVE_NO_FORK) && !(defined(CYGWIN32) || defined(SOLARIS) || defined(UNIX_LIKE))
#define HAVE_NO_FORK
#endif
