    ...
    do {
...

        {
...
#endif /* MARK_BIT_PER_OBJ */
            {
                ...
                GC_ASSERT(hhdr->hb_sz > HBLKSIZE || hhdr->hb_block == HBLKPTR(current));
...
#endif /* MARK_BIT_PER_OBJ */
                {
#if defined(MARK_BIT_PER_OBJ) && !defined(MARK_BIT_PER_GRANULE) /* for cppcheck */
                    size_t obj_displ;
...
#define GC_PUSH_ONE_STACK(p, source)                                                                                \
    do {                                                                                                            \
        if ((word)(p) >= (word)GC_least_plausible_heap_addr && (word)(p) < (word)GC_greatest_plausible_heap_addr) { \
