...
#elif (defined(__DragonFly__) || defined(__FreeBSD_kernel__) || defined(__FreeBSD__)) && !defined(GC_NO_FREEBSD)
...
#define GC_IRIX_THREADS
    ...
    || ((defined(sun) || defined(__sun)) && (defined(i386) || defined(__i386__) || defined(__amd64) || defined(__amd64__)))
#define GC_SOLARIS_THREADS
...
#define GC_CAN_SAVE_CALL_STACKS
    ...
    && !defined(_M_ARM) && !defined(_M_ARM64) && !defined(_AMD64_) && !defined(_M_X64) && !defined(_WIN32_WCE) && !defined(GC_HAVE_NO_BUILTIN_BACKTRACE) && !defined(GC_HAVE_BUILTIN_BACKTRACE)
#define GC_HAVE_BUILTIN_BACKTRACE
#endif
...
#if GC_GNUC_PREREQ(4, 0) && (defined(__i386__) || defined(__amd64__) || defined(__x86_64__) /* and probably others... */) && !defined(GC_NO_RETURN_ADDR_PARENT)
