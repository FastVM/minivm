    ...
    do {                                                                                                                 \
        if (GC_EXPECT((granules) >= GC_TINY_FREELISTS, 0)) {                                                             \
            ...
            void *next;                                                                                                  \
                                                                                                                         \
            for (;;) {                                                                                                   \
                if (GC_EXPECT((GC_word)my_entry > (num_direct) + GC_TINY_FREELISTS + 1, 1)) {                            \
                    next = *(void **)(my_entry);                                                                         \
                ...
                if ((GC_signed_word)my_entry - (GC_signed_word)(num_direct) <= 0 /* (GC_word)my_entry <= (num_direct) */ \
                    && my_entry != 0 /* NULL */) {                                                                       \
                    /* Small counter value, not NULL */                                                                  \
                    GC_FAST_M_AO_STORE(my_fl, (char *)my_entry + (granules) + 1);                                        \
                    result = (default_expr);                                                                             \
                    break;                                                                                               \
                } else {                                                                                                 \
                    /* Large counter or NULL */                                                                          \
                    GC_generic_malloc_many(((granules) == 0 ? GC_GRANULE_BYTES : GC_RAW_BYTES_FROM_INDEX(granules)),     \
                                           kind, my_fl);                                                                 \
                    my_entry = *my_fl;                                                                                   \
                    if (my_entry == 0) {                                                                                 \
