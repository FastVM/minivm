...
struct dasm_State {
    ...
    dasm_Section sections[0]; /* All sections. Alloc-extended. */
};
        ...
        if (action < DASM_DISP) {
            ...
            switch (action) {
                ...
                case DASM_VREG:
                    ...
                    switch ((*p++ >> 3) & 3) {
                        case 3:
                            n |= b[pos - 3]; /* fallthrough */
                        case 2:
                            n |= b[pos - 2]; /* fallthrough */
                        case 1:
                            if (n <= 7) {
                                b[pos - 1] |= 0x10;
                                ofs--;
...
#define dasmq(x)                                               \
    do {                                                       \
        *((unsigned long long *)cp) = (unsigned long long)(x); \
        cp += 8;                                               \
    } while (0)
#else
#define dasmw(x)         \
