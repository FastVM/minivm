...
VM_SRCS := vm/serialize/binary.c vm/ir/ir.c vm/lib.c vm/ir/type.c vm/ast/build.c vm/ast/comp.c vm/ast/print.c vm/obj.c vm/backend/tb.c vm/ir/check.c vm/ir/rblock.c vm/lua/parser.c vm/lua/scan.c vm/lua/ast.c vm/lua/repl.c isocline/isocline.c
