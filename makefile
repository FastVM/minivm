...
SRCS := vm/asm.c vm/jump.c vm/int/run.c vm/int/comp.c vm/int/gc.c vm/reguse.c vm/ir/build.c vm/ir/toir.c vm/ir/opt/const.c vm/ir/opt/dead.c vm/ir/be/js.c
OBJS := $(SRCS:%.c=%.o)
