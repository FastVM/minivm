...
#define vm_gc_get_v(gc_, obj_, nth_) vm_gc_get(gc_, obj_, VM_VALUE_GET_INT(nth_))
#define vm_gc_get_i(gc_, obj_, nth_) vm_gc_get(gc_, obj_, (nth_))

#define vm_gc_set_vv(gc_, obj_, nth_, val_) vm_gc_set(gc_, obj_, VM_VALUE_GET_INT(nth_), val_)
#define vm_gc_set_vi(gc_, obj_, nth_, val_) vm_gc_set(gc_, obj_, VM_VALUE_GET_INT(nth_), VM_VALUE_SET_INT(val_))
#define vm_gc_set_iv(gc_, obj_, nth_, val_) vm_gc_set(gc_, obj_, nth_, val_)
#define vm_gc_set_ii(gc_, obj_, nth_, val_) vm_gc_set(gc_, obj_, nth_, VM_VALUE_SET_INT(val_))
