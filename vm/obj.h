...
static inline bool vm_obj_is_none(vm_obj_t obj) { return nanbox_is_null(obj); }

static inline bool vm_obj_is_bool(vm_obj_t obj) {
  return nanbox_is_boolean(obj);
}

static inline bool vm_obj_is_num(vm_obj_t obj) { return nanbox_is_double(obj); }
...
static inline vm_obj_t vm_obj_of_none(void) { return nanbox_null(); }
