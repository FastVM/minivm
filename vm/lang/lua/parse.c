...
static const TSParseActionEntry ts_parse_actions[] = {
    ...
    REDUCE(sym_bracket_index_expression, 4, .production_id = 23),
    [41] = {.entry = {.count = 1, .reusable = false}},
    REDUCE(sym_bracket_index_expression, 4, .production_id = 23),
    [43] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_dot_index_expression, 3, .production_id = 23),
    ...
    REDUCE(sym__quote_string, 3, .production_id = 28),
    ...
    REDUCE(sym_function_call, 2, .production_id = 10),
    ...
    REDUCE(sym_string, 1, .production_id = 6),
    ...
    REDUCE(sym__quote_string, 2, .production_id = 14),
    ...
    REDUCE(sym__block_string, 3, .production_id = 12),
    ...
    REDUCE(sym__function_body, 3, .production_id = 41),
    [143] = {.entry = {.count = 1, .reusable = false}},
    REDUCE(sym__function_body, 3, .production_id = 41),
    [145] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__function_body, 2, .production_id = 27),
    [147] = {.entry = {.count = 1, .reusable = false}},
    REDUCE(sym__function_body, 2, .production_id = 27),
    [149] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_function_definition, 2, .production_id = 13),
    ...
    REDUCE(sym__variable_assignment_explist, 1, .production_id = 15),
    ...
    REDUCE(sym__att_name_list, 1, .production_id = 4),
    ...
    REDUCE(sym_field, 1, .production_id = 15),
    ...
    REDUCE(sym_field, 3, .production_id = 42),
    ...
    REDUCE(aux_sym__att_name_list_repeat1, 2, .production_id = 25),
    [324] = {.entry = {.count = 1, .reusable = false}},
    REDUCE(aux_sym__att_name_list_repeat1, 2, .production_id = 25),
    [326] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(81),
    [328] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__att_name_list, 3, .production_id = 36),
    ...
    REDUCE(aux_sym__att_name_list_repeat1, 2, .production_id = 37),
    ...
    REDUCE(sym__att_name_list, 2, .production_id = 20),
    ...
    REDUCE(sym__variable_assignment_explist, 2, .production_id = 39),
    ...
    REDUCE(sym_variable_declaration, 2, .production_id = 9),
    ...
    REDUCE(sym_assignment_statement, 3, .production_id = 22),
    [428] = {.entry = {.count = 1, .reusable = false}},
    REDUCE(sym_assignment_statement, 3, .production_id = 22),
    [430] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__local_variable_assignment, 3, .production_id = 38),
    ...
    REDUCE(sym__local_function_declaration, 4, .production_id = 35),
    ...
    REDUCE(sym_parameters, 3, .production_id = 40),
    ...
    REDUCE(sym__variable_assignment_varlist, 1, .production_id = 4),
    [524] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(161),
    [526] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(aux_sym__variable_assignment_varlist_repeat1, 2, .production_id = 25),
    ...
    REDUCE(sym_method_index_expression, 3, .production_id = 24),
    ...
    REDUCE(aux_sym__name_list_repeat1, 2, .production_id = 26),
    SHIFT_REPEAT(223),
    ...
    REDUCE(sym__name_list, 1, .production_id = 4),
    ...
    REDUCE(aux_sym__name_list_repeat1, 2, .production_id = 25),
    [642] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(6),
    [644] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(213),
    [646] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__parameter_list, 2, .production_id = 11),
    ...
    REDUCE(sym__variable_assignment_varlist, 2, .production_id = 11),
    [658] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(212),
    [660] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__parameter_list, 1, .production_id = 4),
    ...
    REDUCE(sym__function_name_dot_index_expression, 3, .production_id = 23),
    [672] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__name_list, 2, .production_id = 11),
    [674] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(aux_sym__variable_assignment_varlist_repeat1, 2, .production_id = 26),
    ...
    REDUCE(sym__parameter_list, 3, .production_id = 4),
    ...
    REDUCE(sym__function_name_method_index_expression, 3, .production_id = 24),
    [731] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(28),
    [733] = {.entry = {.count = 1, .reusable = true}},
    SHIFT(147),
    [735] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym__parameter_list, 4, .production_id = 11),
    ...
    REDUCE(sym_comment, 2, .production_id = 5),
    [773] = {.entry = {.count = 1, .reusable = true}},
    REDUCE(sym_comment, 3, .production_id = 12),
};
