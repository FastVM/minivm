...
vm_instr_t vm_rblock_type_specialize_instr(vm_config_t *config, vm_types_t *a, vm_instr_t instr);
vm_branch_t vm_rblock_type_specialize_branch(vm_config_t *config, vm_types_t *a, vm_branch_t block);
