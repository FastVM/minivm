...
static inline const char *vm_int_debug_instr_name(size_t op) {
    static const char *table[] = {
        ...
        [VM_INT_OP_IMOV_R] = "imov",
        [VM_INT_OP_DYNBEQ_RRLL] = "beq.dyn",
        [VM_INT_OP_DYNBEQ_RRTT] = "beq.dyn",
...
static inline const char *vm_int_debug_instr_format(size_t opcode) {
    static const char *table[] = {
        ...
        [VM_INT_OP_FMOV_R] = ";i",
        [VM_INT_OP_IMOV_R] = ";f",
        [VM_INT_OP_DYNBEQ_RRLL] = "?aaLL",
        [VM_INT_OP_DYNBEQ_RRTT] = "?aaTT",
        ...
        [VM_INT_OP_I32BLT_RRLL] = "?iiTT",
        [VM_INT_OP_I32BLT_RILL] = "?iITT",
        [VM_INT_OP_I32BLT_IRLL] = "?IiTT",
        [VM_INT_OP_I32BEQ_RRLL] = "?iiTT",
        [VM_INT_OP_I32BEQ_RILL] = "?iITT",
        [VM_INT_OP_I32BEQ_IRLL] = "?IiTT",
        ...
        [VM_INT_OP_FBLT_RRLL] = "?ffTT",
        [VM_INT_OP_FBLT_RFLL] = "?fFTT",
        [VM_INT_OP_FBLT_FRLL] = "?FfTT",
        [VM_INT_OP_FBEQ_RRLL] = "?ffTT",
        [VM_INT_OP_FBEQ_RFLL] = "?fFTT",
        [VM_INT_OP_FBEQ_FRLL] = "?FfTT",
