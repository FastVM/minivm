...
void vm_run(vm_state_t *state, vm_block_t *block) {
    ...
    state->ptrs = ptrs;
    vm_run_block_t rblock;
    rblock.block = block;
    rblock.args = NULL;
    vm_opcode_t *restrict ip = vm_run_comp(state, &rblock);
    ...
    do_jump_ptr_const: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_JUMP_PTR_CONST\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    do_jump_func_const: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_JUMP_FUNC_CONST\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    do_call_ptr_const: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    do_call_func_const: {
    ...
    do_call_func_reg: {
        vm_run_block_t *t0 = locals[(ip++)->reg].func;
        locals += 256;
        *(ips++) = ip;
    ...
    do_call_ptr_const_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg_reg_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG_REG_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
    ...
    do_call_ptr_const_reg_reg_reg_reg_reg_reg_reg_reg: {
        fprintf(stderr, "unimplemend label: VM_OPCODE_CALL_PTR_CONST_REG_REG_REG_REG_REG_REG_REG_REG\n");
        __builtin_trap();
        goto *(ip++)->ptr;
    }
