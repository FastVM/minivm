...
enum {
    ...
    VM_OPCODE_TYPE_I8_REG = 46,
    VM_OPCODE_TYPE_I8_CONST = 47,
    VM_OPCODE_BNOT_I8_REG = 48,
    VM_OPCODE_BNOT_I8_CONST = 49,
    VM_OPCODE_RET_I8_REG = 50,
    VM_OPCODE_RET_I8_CONST = 51,
    ...
    VM_OPCODE_TYPE_I16_REG = 117,
    VM_OPCODE_TYPE_I16_CONST = 118,
    VM_OPCODE_BNOT_I16_REG = 119,
    VM_OPCODE_BNOT_I16_CONST = 120,
    VM_OPCODE_RET_I16_REG = 121,
    VM_OPCODE_RET_I16_CONST = 122,
    ...
    VM_OPCODE_TYPE_I32_REG = 188,
    VM_OPCODE_TYPE_I32_CONST = 189,
    VM_OPCODE_BNOT_I32_REG = 190,
    VM_OPCODE_BNOT_I32_CONST = 191,
    VM_OPCODE_RET_I32_REG = 192,
    VM_OPCODE_RET_I32_CONST = 193,
    ...
    VM_OPCODE_TYPE_I64_REG = 259,
    VM_OPCODE_TYPE_I64_CONST = 260,
    VM_OPCODE_BNOT_I64_REG = 261,
    VM_OPCODE_BNOT_I64_CONST = 262,
    VM_OPCODE_RET_I64_REG = 263,
    VM_OPCODE_RET_I64_CONST = 264,
    ...
    VM_OPCODE_TYPE_U8_REG = 330,
    VM_OPCODE_TYPE_U8_CONST = 331,
    VM_OPCODE_BNOT_U8_REG = 332,
    VM_OPCODE_BNOT_U8_CONST = 333,
    VM_OPCODE_RET_U8_REG = 334,
    VM_OPCODE_RET_U8_CONST = 335,
    ...
    VM_OPCODE_TYPE_U16_REG = 401,
    VM_OPCODE_TYPE_U16_CONST = 402,
    VM_OPCODE_BNOT_U16_REG = 403,
    VM_OPCODE_BNOT_U16_CONST = 404,
    VM_OPCODE_RET_U16_REG = 405,
    VM_OPCODE_RET_U16_CONST = 406,
    ...
    VM_OPCODE_TYPE_U32_REG = 472,
    VM_OPCODE_TYPE_U32_CONST = 473,
    VM_OPCODE_BNOT_U32_REG = 474,
    VM_OPCODE_BNOT_U32_CONST = 475,
    VM_OPCODE_RET_U32_REG = 476,
    VM_OPCODE_RET_U32_CONST = 477,
    ...
    VM_OPCODE_TYPE_U64_REG = 543,
    VM_OPCODE_TYPE_U64_CONST = 544,
    VM_OPCODE_BNOT_U64_REG = 545,
    VM_OPCODE_BNOT_U64_CONST = 546,
    VM_OPCODE_RET_U64_REG = 547,
    VM_OPCODE_RET_U64_CONST = 548,
    ...
    VM_OPCODE_TYPE_F32_REG = 614,
    VM_OPCODE_TYPE_F32_CONST = 615,
    VM_OPCODE_BNOT_F32_REG = 616,
    VM_OPCODE_BNOT_F32_CONST = 617,
    VM_OPCODE_RET_F32_REG = 618,
    VM_OPCODE_RET_F32_CONST = 619,
    ...
    VM_OPCODE_TYPE_F64_REG = 665,
    VM_OPCODE_TYPE_F64_CONST = 666,
    VM_OPCODE_BNOT_F64_REG = 667,
    VM_OPCODE_BNOT_F64_CONST = 668,
    VM_OPCODE_RET_F64_REG = 669,
    VM_OPCODE_RET_F64_CONST = 670,
    VM_OPCODE_EXIT_BREAK_VOID = 671,
    VM_OPCODE_CALL_FUNC_CONST = 672,
    VM_OPCODE_CALL_FUNC_REG = 673,
    VM_OPCODE_CALL_FUNC_CONST_REG = 674,
    VM_OPCODE_CALL_FUNC_REG_REG = 675,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG = 676,
    VM_OPCODE_CALL_FUNC_REG_REG_REG = 677,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG = 678,
    VM_OPCODE_CALL_FUNC_REG_REG_REG_REG = 679,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG_REG = 680,
    VM_OPCODE_CALL_FUNC_REG_REG_REG_REG_REG = 681,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG_REG_REG = 682,
    VM_OPCODE_CALL_FUNC_REG_REG_REG_REG_REG_REG = 683,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG_REG_REG_REG = 684,
    VM_OPCODE_CALL_FUNC_REG_REG_REG_REG_REG_REG_REG = 685,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG_REG_REG_REG_REG = 686,
    VM_OPCODE_CALL_FUNC_REG_REG_REG_REG_REG_REG_REG_REG = 687,
    VM_OPCODE_CALL_FUNC_CONST_REG_REG_REG_REG_REG_REG_REG_REG = 688,
